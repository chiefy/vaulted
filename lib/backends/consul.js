...
module.exports = function extend(Proto) {
  Vaulted.getConsulRolesEndpoint = _.partial(Proto.validateEndpoint, '%s/roles/:id');
  Vaulted.getConsulCredsEndpoint = _.partial(Proto.validateEndpoint, '%s/creds/:id');
  Vaulted.getConsulAccessEndpoint = _.partial(Proto.validateEndpoint, '%s/config/access');
