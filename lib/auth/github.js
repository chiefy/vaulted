...
module.exports = function extend(Proto) {
  Vaulted.getGithubMapTeamsEndpoint = _.partialRight(
    _.partial(Proto.validateEndpoint, 'auth/%s/map/teams/:id'), 'github');
  Vaulted.getGithubConfigEndpoint = _.partialRight(
    _.partial(Proto.validateEndpoint, 'auth/%s/config'), 'github');
